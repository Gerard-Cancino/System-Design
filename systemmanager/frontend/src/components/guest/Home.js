            ...
            <div className="col-md-4">
              <div className="card">
                <div className="card-body">
                  ...
                  <p className="card-text">This is a great school. Highly Educational!</p>
                </div>
              </div>
            </div>
            <div className="col-md-4">
              <div className="card">
                <div className="card-body">
                  ...
                  <p className="card-text">100% Hire Rate after graduation</p>
                </div>
              </div>
            </div>
            <div className="col-md-4">
              <div className="card">
                <div className="card-body">
                  ...
                  <p className="card-text">1% Acceptacnce Rate</p>
                </div>
              </div>
            </div>
          </div>
