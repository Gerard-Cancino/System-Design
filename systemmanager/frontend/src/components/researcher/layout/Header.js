    ...
    return (
      ...
      <header id="navtop" className="container-fluid sticky-top">
        <nav className="row navbar navbar-expand-md bg-white navbar-light border-bottom">
          <Link id="logo" className="navbar-brand" to="/researcher/main">Garage University</Link>
          ...
          <div className="collapse navbar-collapse" id="collapsibleNavbar">
            <ul className="navbar-nav ml-auto">
              <li className="nav-item">
                <Link className="nav-link" to="/researcher/main">Main Page</Link>
              </li>
              <li className="nav-item">
                <Link onClick={logout} className="nav-link" to="/login">Logout</Link>
              </li>
              <li className="nav-item">
                <Link className="nav-link" to="/researcher/view-edit-profile">My Profile</Link>
              </li>
