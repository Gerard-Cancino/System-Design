    ...
    return (
      <div className="col-md-12">
        ...
        <form onSubmit={this.handlerFindStudent}>
          ...
          <input className="form-control" type="text" value={this.state.studentUsername} placeholder="Enter Student's Username" onChange={this.handlerStudent} required/>
  ...
  Term = () => {
    return (
      this.state.termList.length ==0?(
        ...
        <div>
          <label>Term:</label>
          <select className="form-control" onChange={this.handleChange} value={this.state.term} required>
