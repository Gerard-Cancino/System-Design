# Generated by Django 2.1.5 on 2019-04-16 21:54
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.IntegerField(primary_key=True, serialize=False)),
                ('name', models.CharField(choices=[('SU', 'Sunday'), ('MO', 'Monday'), ('TU', 'Tuesday'), ('WE', 'Wednesday'), ('TH', 'Thursday'), ('FR', 'Friday'), ('SA', 'Saturday')], max_length=2)),
            ],
            options={
                'db_table': 'day',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('L', 'Lab'), ('C', 'Class'), ('O', 'Office'), ('F', 'Faculty'), ('S', 'Symphony Hall')], max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('season', models.CharField(choices=[('W', 'WINTER'), ('SP', 'SPRING'), ('SU', 'SUMMER'), ('F', 'FALL')], max_length=1)),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend.Course')),
            ],
            options={
                'db_table': 'transcript',
        ...
        migrations.CreateModel(
            name='Attendance',
            fields=[
                ('enrollment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='backend.Enrollment')),
        ...
        migrations.AddField(
            ...
            name='course_section',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend.CourseSection'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='advisor',
            name='faculty',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='backend.Faculty'),
        ),
        migrations.AddField(
            model_name='advisor',
            name='student',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='backend.Student'),
        ),
        migrations.CreateModel(
